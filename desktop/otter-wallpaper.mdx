...
These commands work well as compositor keybindings:

```bash
otter-settings --wallpaper-picker
otter-wallpaper --random
```
...
This is Niri's own overview backdrop. The Otter Shell overlay is a separate app: [otter-overview](/desktop/otter-overview).
