...
`otter-greeter` handles login before your user compositor session starts.
...
The greeter UI runs on **Hyprland** for the login screen only. Your session compositor is separate. The greeter does not pick one for you.
