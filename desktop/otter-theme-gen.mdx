...
If the wallpaper hash has not changed, the daemon skips the work.
...
Optional template keys rewrite third-party config files when colors change. Templates start disabled. Turn on only the apps you want synced.
