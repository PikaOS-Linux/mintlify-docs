...
`otter-notifications` implements `org.freedesktop.Notifications` on D-Bus. Apps that use `notify-send` or the standard notification API keep working.
...
Config and theme hot-reload through inotify.
