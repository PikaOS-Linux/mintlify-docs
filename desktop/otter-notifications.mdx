...
`otter-notifications` implements the `org.freedesktop.Notifications` D-Bus service. Apps that call `notify-send` or the standard notification API work without changes.
