...
`otter-logout` is a power menu: lock, logout, suspend, reboot, shutdown. Run it from a hotkey or the bar menu button. One process per open; it exits when you pick an action or dismiss it.
