...
`otter-idle` watches for inactivity and runs commands you configure, usually `loginctl lock-session` or turning displays off. It also hooks into systemd-logind for sleep events and screen saver inhibition.
