...
<Tip>
  After autostarting shell daemons, open **`otter-settings`** to configure the bar layout, theme, terminal fonts, and every other app. This is the recommended way to customize Otter Shell — no need to edit `.conf` files by hand.
</Tip>
