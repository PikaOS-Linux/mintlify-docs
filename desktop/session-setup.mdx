...
Do not autostart one-shot apps: `otter-launcher`, `otter-overview`, `otter-logout`, `otter-screenshot`. Bind hotkeys instead.
...
|-----------|---------------------|
| Bar, launcher, overview, notifications, OSD, logout, lock | `zwlr_layer_shell_v1` (wlroots layer shell) |
