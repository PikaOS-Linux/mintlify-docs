...
**`otter-settings`** is the default way to configure Otter Shell. It gives installed apps their own tabs, plus a theme browser and drag-and-drop bar layout. If you prefer `$EDITOR`, both routes change the same files.
