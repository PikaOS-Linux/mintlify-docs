...
Otter Shell ships as native packages on PikaOS. They are built and versioned together in [otter-zenith](https://git.pika-os.com/otter-shell/otter-zenith). Gaming tools ship from [otter-gaming-utils](https://git.pika-os.com/otter-shell/otter-gaming-utils). Install with **pikman**.
