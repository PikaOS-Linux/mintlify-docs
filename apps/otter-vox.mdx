...
description: "otter-vox converts text to speech on-device using an embedded Kokoro TTS model. Requires the otter-shell-extras metapackage."
---

otter-vox turns text into speech on your local machine using an embedded Kokoro TTS model — no internet connection required.
