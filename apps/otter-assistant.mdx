...
You can also open **Otter Assistant** from [otter-launcher](/desktop/otter-launcher). Start `otter-assist` first, or autostart it. If the daemon is not running, you get no replies.
