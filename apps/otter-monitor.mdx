...
`otter-monitor` is a normal Wayland window with live CPU, memory, GPU, disk, and network stats. Sort and search processes, group desktop apps, and end tasks from the table.
