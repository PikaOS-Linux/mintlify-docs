...
- **Background** picks screenshot-derived gradient swatches (generated from the current capture), predefined gradients, a wallpaper image through the xdg-desktop-portal file picker, or the current `otter-wallpaper` state on your desktop. Screenshot swatches appear first after you capture. Click the wallpaper field to open the portal picker.
