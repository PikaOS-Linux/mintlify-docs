...
Otter Bench is the desktop front end for Otter HUD and the benchmarking suite. Edit overlay layouts against a live preview that uses the same draw stream as the in-game HUD. You can browse recorded sessions, run benchmark plans, or launch a game with the HUD attached.
