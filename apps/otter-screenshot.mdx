...
Run `otter-screenshot` without arguments to enter region-selection mode. Drag with the left mouse button to define the area. Press <kbd>Esc</kbd> or <kbd>Ctrl+C</kbd> before selecting to cancel.
