...
`otter-clicker` clicks for you. Lock a point with the crosshair overlay, or click wherever the pointer already sits. If the compositor supports virtual pointers, moving the real mouse will not steal that fixed target.
