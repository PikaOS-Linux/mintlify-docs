...
For ASCII-only chrome you can omit `text_system` and `text_scratch`. Any UI that may show RTL, CJK, or user-provided strings should pass both (see `otter-lock/src/lock_render_loop.zig`).
