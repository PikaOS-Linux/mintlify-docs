...
description: "Start a new Wayland application using Otter libraries — dependencies, UI pattern, and config setup."
---

This guide walks through creating a new Wayland application that integrates with the Otter Shell stack.
