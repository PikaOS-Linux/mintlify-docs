...
Powerline separators, block-drawing characters, and private-use cell glyphs. These fill gaps when a font does not cover the shapes a terminal prompt expects.
