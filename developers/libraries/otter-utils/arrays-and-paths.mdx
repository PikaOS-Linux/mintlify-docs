...
Hot paths skip the heap. These types give you fixed-capacity containers and stack path builders. Daemons use them for hit lists, workspace IDs, and damage rects.
