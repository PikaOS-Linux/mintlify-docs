...
`otter-desktop` connects Otter Shell to the host OS: icon themes, application entries, session services, audio, brightness, and system metrics.

Bar widgets, settings, greeter, lock, and monitor import subsets of this library.
