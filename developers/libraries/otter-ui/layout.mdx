...
`scroll_area` enables scissor clipping automatically. Pair it with app-managed scroll offset and a `UniformList` when virtualizing long lists (see [Input and overlays](/developers/libraries/otter-ui/input-and-overlays)).
