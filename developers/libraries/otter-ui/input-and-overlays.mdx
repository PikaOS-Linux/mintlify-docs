...
`render` records hit regions. Your Wayland loop then passes pointer and keyboard events through `dispatch`. You can also call `hitTest` yourself if you need to.
