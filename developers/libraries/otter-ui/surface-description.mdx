...
Surface Description is the frame API. You build a `SurfaceNode` tree. Each frame, `UiFrame` measures it, places rects, emits `otter-render` commands, and records click targets.
