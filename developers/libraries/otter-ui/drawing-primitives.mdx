...
`ui.drawing` is stateless draw helpers that append to a `DefaultCommandList`. Surface Description calls them internally. Use them when you need drawing outside the node tree:
