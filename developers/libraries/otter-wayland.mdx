...
`otter-wayland` wraps the Wayland client APIs Otter Shell apps share: compositor connection, layer and XDG surfaces, pointer and keyboard input, clipboard, SHM buffers, and screen capture.

Poll `Connection.dispatch()` in your main loop alongside config watchers and timer FDs.
