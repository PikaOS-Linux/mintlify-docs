...
Drag-to-select for screenshots, product shots, and recordings. It composites pixels directly to SHM buffers with incremental damage. Surface Description is not used here.
