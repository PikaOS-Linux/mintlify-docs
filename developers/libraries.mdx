...
description: "Shared Otter Shell Zig libraries: what each one does and how apps use them."
---

Otter Shell apps share eleven libraries. They link into application binaries at build time. There are no separate library packages for end users.
...
Comptime-generic configuration parser. Define a Zig struct and you get a specialized parser at compile time.
