...
description: "In-app shortcuts for Otter Shell apps and compositor global hotkey examples for Hyprland, Sway, and other Wayland compositors."
---

Otter Shell apps define in-app keyboard shortcuts in their config files — edit these in [otter-settings](/desktop/otter-settings) (Terminal, Launcher, etc. tabs) or directly in each app's `.conf` file. Global hotkeys must be bound in your Wayland compositor.
...
| Service | Purpose |
|---------|---------|
| `otter-bar` | Status bar — required for tray, clock widgets, and weather display |
