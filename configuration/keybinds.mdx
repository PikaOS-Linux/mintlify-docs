...
Otter Shell apps define in-app keyboard shortcuts in their config files. Global hotkeys — triggering a screenshot or opening the launcher from anywhere — must be bound in your Wayland compositor. Otter Shell does not ship or require a specific compositor.
...
Edit `~/.config/otter-shell/otter-term.conf`:
